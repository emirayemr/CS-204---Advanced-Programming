...
#include <fstream>
#include <sstream>
#include "Emiray_Ay_Emir_hw6_Board.h" //change this with your board header file name
#include "Emiray_Ay_Emir_hw6_Player.h" //change this with your player header file name
